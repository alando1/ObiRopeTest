...
namespace Obi{
	...
	public class ObiRopeEditor : ObiParticleActorEditor
	{
		...
		public override void OnInspectorGUI() {
			...
			// Render modes:
			/*switch (rope.RenderMode){

				case ObiRope.RenderingMode.Line:{
					DrawRenderMode(lineRenderMode);
					EditorGUILayout.PropertyField(sectionThicknessScale);
					EditorGUILayout.PropertyField(uvScale);
					EditorGUILayout.PropertyField(uvAnchor);
					EditorGUILayout.PropertyField(normalizeV);
				}break;

				case ObiRope.RenderingMode.Chain:{
					DrawRenderMode(chainRenderMode);
				}break;

				case ObiRope.RenderingMode.ProceduralRope:{
					DrawRenderMode(thickRenderMode);
					EditorGUILayout.PropertyField(section);
					EditorGUILayout.PropertyField(sectionThicknessScale);	
					EditorGUILayout.PropertyField(sectionTwist);
					EditorGUILayout.PropertyField(uvScale);
					EditorGUILayout.PropertyField(uvAnchor);
					EditorGUILayout.PropertyField(normalizeV);
				}break;

				case ObiRope.RenderingMode.CustomMesh:{
					DrawRenderMode(meshRenderMode);
				}break;
			}*/
